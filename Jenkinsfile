...
stage('Pushing to ECR') {
     steps{  
         script {
                ...
                def sshCommand = "ssh -o BatchMode=yes app_devops@172.31.84.99 'docker run -d -p 8080:8080 --name nodejs_deploy  614217881944.dkr.ecr.us-east-1.amazonaws.com/nodejs-appb274afd63b71:latest'"
                sh sshCommand
         }
        }
      }
